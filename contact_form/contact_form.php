...
// configure
$from = 'ali.algburi@student.ucll.be'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'ali.algburi@student.ucll.be'; // Replace it with Your email. REQUIRED!
